    ...
    ca: {
      ...
      steps: [
        { label: 'Qui ets?', type: 'radio', key: 'perfil', required: true,
          options: ['Artista / Músic', 'Actor / Actriu', 'Fotògraf / Autora visual', 'Manager', 'Sala de concerts', 'Festival', 'Discogràfica / Promotora'] },
        { label: 'Què necessites?', hint: 'Pots triar més d\'una opció.', type: 'checkbox', key: 'necessitats', required: true,
          options: ['Fotografia de directes', 'Fotografia promocional', 'Identitat visual (Ressona.eu)', 'Web o microsite', 'Xarxes socials', 'Pla de comunicació global', 'Publicació de fotobook (112 Revelats)', 'Automatismes i eines IA', 'Vídeo'] },
    ...
    en: {
      ...
      steps: [
        { label: 'Who are you?', type: 'radio', key: 'perfil', required: true,
          options: ['Artist / Musician', 'Actor / Actress', 'Photographer / Visual artist', 'Manager', 'Concert venue', 'Festival', 'Record label / Promoter'] },
        { label: 'What do you need?', hint: 'You can select more than one.', type: 'checkbox', key: 'necessitats', required: true,
          options: ['Live photography', 'Promotional photography', 'Digital identity (Ressona.eu)', 'Website or microsite', 'Social media', 'Global communication plan', 'Photobook publication (112 Revelats)', 'Automation & AI tools', 'Video'] },
    ...
    es: {
      ...
      steps: [
        { label: '¿Quién eres?', type: 'radio', key: 'perfil', required: true,
          options: ['Artista / Músico', 'Actor / Actriz', 'Fotógrafo / Autora visual', 'Manager', 'Sala de conciertos', 'Festival', 'Discográfica / Promotora'] },
        { label: '¿Qué necesitas?', hint: 'Puedes elegir más de una opción.', type: 'checkbox', key: 'necessitats', required: true,
          options: ['Fotografía de directos', 'Fotografía promocional', 'Identidad digital (Ressona.eu)', 'Web o microsite', 'Redes sociales', 'Plan de comunicación global', 'Publicación de fotobook (112 Revelats)', 'Automatismos y herramientas IA', 'Vídeo'] },
